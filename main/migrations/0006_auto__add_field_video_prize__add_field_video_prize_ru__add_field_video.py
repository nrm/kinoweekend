...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Video.prize'
        db.add_column('main_video', 'prize', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True), keep_default=False)

        # Adding field 'Video.prize_ru'
        db.add_column('main_video', 'prize_ru', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Video.prize_en'
        db.add_column('main_video', 'prize_en', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Video.prize'
        db.delete_column('main_video', 'prize')

        # Deleting field 'Video.prize_ru'
        db.delete_column('main_video', 'prize_ru')

        # Deleting field 'Video.prize_en'
        db.delete_column('main_video', 'prize_en')
    ...
    models = {
        ...
        'main.video': {
            ...
            'prize': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'prize_en': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'prize_ru': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'db_index': 'True'}),
